...
cp /home/centos/Devops-1/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
cp /home/centos/Devops-1/mongo.repo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
